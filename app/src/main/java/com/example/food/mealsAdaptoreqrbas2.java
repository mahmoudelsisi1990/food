...
public class mealsAdaptoreqrbas2 extends RecyclerView.Adapter<mealsAdaptoreqrbas2.Holder> implements Filterable {
    ...
    class Holder extends RecyclerView.ViewHolder {
      //  TextView titale;
        ...
        public Holder(@NonNull View itemView) {
            super(itemView);
            text =itemView.findViewById(R.id.texttayp1);
                image1 = itemView.findViewById(R.id.imageViewtayp1);
        }
    }

    public mealsAdaptoreqrbas2(int layout, ArrayList<Tayps> pesonal, Context context) {
